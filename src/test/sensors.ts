...
describe("Movement Sensor", () => {
    ...
    describe("when receiving events with movement", () => {
        ...
        it("should return moving state", () => {
            handler("pitch:0;roll:0;yaw:0;vgx:0;vgy:0;vgz:-1;templ:91;temph:94;tof:10;h:0;bat:89;baro:-26.51;time:18;agx:-12.00;agy:-4.00;agz:-1245.00;")
            assert.equal(state, FlightState.moving)
        })
        it("should return hovering state", () => {
            hoverQueue.forEach((event) => handler(event))
